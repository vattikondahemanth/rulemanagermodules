...
import { KendoInput, ResizeSensorModule, isChanged, isDocumentAvailable } from '@progress/kendo-angular-common';
import { FormsModule, NG_VALUE_ACCESSOR } from '@angular/forms';
import { ComponentMessages, L10N_PREFIX, LocalizationService } from '@progress/kendo-angular-l10n';
import { Subject, Subscription, fromEvent, interval, merge, of } from 'rxjs';
import { auditTime, catchError, concatMap, distinctUntilChanged, filter, map, partition, skipWhile, take, takeUntil, tap, throttleTime } from 'rxjs/operators';
...
var ListComponent = /** @class */ (function () {
    ...
    ListComponent.prototype.positionItems = function () {
        ...
        this.items.forEach(function (item, index) {
            var offsetY = 0;
            offsetY = Math.min(_this.scrollHeight - _this.lastScrollTop, offsetY);
            offsetY = offsetY + ((index + _this.startFrom) * _this.virtual.itemHeight);
