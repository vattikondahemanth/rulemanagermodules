...
class DateRangePopupComponent {
    ...
    _toggle(show) {
        ...
        if (this._show) {
            ...
            this.addSubscriptions(this.zone.runOutsideAngular(() => fromEvent(popupElement, 'keydown').subscribe(this.handleKeydown.bind(this))), fromEvent(popupElement, 'mouseleave').subscribe(this.handleMouseLeave.bind(this)), popupAnchorViewportLeave.subscribe(() => this.cancelPopup()));
        }
    }
}
 ...
 * @hidden
 */
class Messages$5 extends ComponentMessages {
}
Messages$5.propDecorators = {
    toggle: [{ type: Input }],
    dateTab: [{ type: Input }],
 ...
 * Custom component messages override default component messages ([see example]({% slug globalization_dateinputs %}#toc-custom-messages)).
 */
class DateTimePickerCustomMessagesComponent extends Messages$5 {
    constructor(service) {
        super();
        this.service = service;
    }
 ...
 * @hidden
 */
class LocalizedMessagesDirective$5 extends Messages$5 {
    constructor(service) {
        super();
        this.service = service;
    }
}
LocalizedMessagesDirective$5.decorators = [
    { type: Directive, args: [{
                providers: [
                    {
                        provide: Messages$5,
                        useExisting: forwardRef(() => LocalizedMessagesDirective$5)
                    }
                ],
...
/** @nocollapse */
LocalizedMessagesDirective$5.ctorParameters = () => [
    { type: LocalizationService }
];

const COMPONENT_DIRECTIVES$9 = [
    DateTimePickerComponent,
    DateTimePickerCustomMessagesComponent,
    LocalizedMessagesDirective$5
];
const ɵ0$23 = touchEnabled;
/**
 * Represents the [NgModule]({{ site.data.urls.angular['ngmoduleapi'] }})
