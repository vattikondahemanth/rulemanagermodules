 ...
 * @hidden
 */
export var hasFilter = function (settings, column) { return settings.filter && column.field && column.filterable; };
/**
 * @hidden
 */
export var hasSort = function (settings, column) { return settings.sort && column.field && column.sortable; };
/**
 * @hidden
 */
