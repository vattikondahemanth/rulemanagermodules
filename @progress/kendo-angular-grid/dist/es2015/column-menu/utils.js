 ...
 * @hidden
 */
export const hasFilter = (settings, column) => settings.filter && column.field && column.filterable;
/**
 * @hidden
 */
export const hasSort = (settings, column) => settings.sort && column.field && column.sortable;
/**
 * @hidden
 */
