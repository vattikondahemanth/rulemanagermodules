...
exports.ScrollBottomAction = ScrollBottomAction;
...
var ScrollerService = /** @class */ (function () {
    ...
    ScrollerService.prototype.create = function (rowHeightService, skip, take, total) {
        ...
        var subject = new rxjs_1.BehaviorSubject(new ScrollAction(this.rowHeightService.offset(skip)));
        this.subscription = rxjs_1.Observable.create(function (observer) {
            _this.unsubscribe();
