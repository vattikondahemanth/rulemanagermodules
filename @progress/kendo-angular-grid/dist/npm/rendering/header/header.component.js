...
var HeaderComponent = /** @class */ (function () {
    ...
    HeaderComponent.prototype.sortColumn = function (column, event, link) {
        ...
        if (column.headerTemplateRef && target !== link && dom_queries_1.isFocusable(target, false)) {
    ...
    HeaderComponent.prototype.leafColumnIndex = function (column) {
        return this.leafColumns.indexOf(column) + (utils_1.isPresent(this.detailTemplate) ? 1 : 0);
    };
