 ...
 * @hidden
 */
exports.hasFilter = function (settings, column) { return settings.filter && column.field && column.filterable; };
/**
 * @hidden
 */
exports.hasSort = function (settings, column) { return settings.sort && column.field && column.sortable; };
/**
 * @hidden
 */
