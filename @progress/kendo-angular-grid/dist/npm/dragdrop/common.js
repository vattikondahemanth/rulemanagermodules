 ...
 */
exports.isTargetBefore = function (draggable, target) {
 ...
 */
exports.contains = function (element, container) {
 ...
 * @hidden
 */
exports.position = function (target, before) {
    var targetRect = exports.offset(target);
